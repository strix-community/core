...
return [
    ...
    */
    ...
    'themes_path' => resource_path('themes'), // eg: base_path('resources/themes')
	...
	*/
	...
	'themes' => [
        ...
        'Strix' => [
            ...
            'views-path'     => 'Strix/views', // = resources/views/example_theme
            'asset-path'     => 'themes/Strix', // = public/example_theme
        ],
